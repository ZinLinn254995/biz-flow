...
export function BusinessExpenseForm({
  ...
  useEffect(() => {
    if (open) {
      setBusinessId(expense?.businessId ?? '');
  ...
  const availableCategories = categories.filter(
    (c) => c.scope === 'business' && (!c.direction || c.direction === 'expense'),
  );
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} noValidate className="px-5 py-4 space-y-4">
          <div>
            <label htmlFor="expense-business" className="block text-sm font-medium text-gray-700 mb-1.5">
          ...
          <div>
            <label htmlFor="expense-title" className="block text-sm font-medium text-gray-700 mb-1.5">
          ...
          <div>
            <label htmlFor="expense-notes" className="block text-sm font-medium text-gray-700 mb-1.5">
              Notes
            </label>
            <textarea
              id="expense-notes"
