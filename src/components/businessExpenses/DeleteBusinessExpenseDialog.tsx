...
interface DeleteBusinessExpenseDialogProps {
  open: boolean;
...
export function DeleteBusinessExpenseDialog({
  open,
  expense,
  isDeleting,
  errorMessage,
  onConfirm,
  onCancel,
}: DeleteBusinessExpenseDialogProps) {
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <h2 id="delete-expense-title" className="text-base font-semibold text-gray-900">
              Delete Expense
            </h2>
          </div>
          <button
        ...
        <div className="px-5 py-4">
          <p className="text-sm text-gray-600 leading-relaxed">
            Are you sure you want to delete <span className="font-semibold text-gray-900">{expense.title}</span>?
