...
interface DeletePersonalIncomeDialogProps {
  open: boolean;
...
export function DeletePersonalIncomeDialog({
  open,
  income,
  isDeleting,
  errorMessage,
  onConfirm,
  onCancel,
}: DeletePersonalIncomeDialogProps) {
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <h2 id="delete-income-title" className="text-base font-semibold text-gray-900">
              Delete Income
            </h2>
          </div>
          <button
        ...
        <div className="px-5 py-4">
          <p className="text-sm text-gray-600 leading-relaxed">
            Are you sure you want to delete <span className="font-semibold text-gray-900">{income.source}</span>?
