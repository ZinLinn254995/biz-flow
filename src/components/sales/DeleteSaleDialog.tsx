      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <h2 id="delete-sale-title" className="text-base font-semibold text-gray-900">
              Delete Sale
            </h2>
          </div>
          <button
        ...
        <div className="px-5 py-4">
          <p className="text-sm text-gray-600 leading-relaxed">
            Are you sure you want to delete the sale from{' '}
            <span className="font-semibold text-gray-900">{formatDate(sale.date)}</span>?
