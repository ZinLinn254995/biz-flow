...
function repo(): SavedItemRepository { return { getById: vi.fn(), getAll: vi.fn(), create: vi.fn(), update: vi.fn(), remove: vi.fn(), getByScope: vi.fn(), getByKind: vi.fn(), getByCategoryId: vi.fn(), getFavorites: vi.fn(), setFavorite: vi.fn() }; }
